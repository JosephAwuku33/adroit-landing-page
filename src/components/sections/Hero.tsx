      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="flex flex-col md:flex-row gap-3 items-center">
          <div className="w-full md:w-3/5 lg:w-2/5 mb-12 md:mb-0">
            ...
            <p className="mt-4 text-accent text-base font-inter leading">
            ...
            <button className="flex items-center justify-center gap-3 mt-8 bg-primary text-white px-8 py-3 font-inter w-full md:w-3/4">
